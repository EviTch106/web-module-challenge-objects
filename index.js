...
console.log(createMenuItem,('phone', 100, 'device'));
console.log(createMenuItem('pizza', 5 , 'Lunch'));
console.log(createMenuItem('hat', 15 , 'Item'));
...
function getLastReview(array) {
  return `${array[array.length-1].name} gave the restaurant a ${array[array.lenght -1].
  rating} start review, and their feedback was: ${array[array.length -1].feedback}`;
